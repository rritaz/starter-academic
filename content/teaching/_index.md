...
<div class="teaching-areas-box"><div class="teaching-areas-icon"><i class="fas fa-graduation-cap"></i></div><div class="teaching-areas-content"><div class="teaching-areas-title">Teaching Areas</div><div class="teaching-grid"><div class="teaching-label">Biostatistics</div><div class="teaching-value">Descriptive statistics, linear, generalized linear, and longitudinal models, survival analysis, and statistical inference &amp; estimation </div><div class="teaching-label">Research Methods</div><div class="teaching-value">Design of experiments &amp; observational studies, causal inference, bias, confounding, effect modification and interpretation of statistical evidence</div><div class="teaching-label">Statistical Computing</div><div class="teaching-value">Data management & visualization, reproducible workflows and applied data analysis in R statistical software </div></div></div></div>
